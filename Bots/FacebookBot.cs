...
namespace ADS.Bot1.Bots
{
    public class FacebookBot : ActivityHandler
    {
        ...
        protected override async Task OnMessageActivityAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
        {
            ...
            string json = JsonConvert.SerializeObject(turnContext.Activity.ChannelData, new JsonSerializerSettings() { ReferenceLoopHandling = ReferenceLoopHandling.Ignore });
